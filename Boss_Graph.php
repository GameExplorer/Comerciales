...
// Requête SQL pour les ventes par année
$sql_ventes_annee = "
    SELECT 
...
// Préparer et exécuter la requête pour les ventes par année
...
// Récupérer les résultats des ventes par année
$results_annee = [];
...
// Convertir les résultats des ventes par année en JSON pour JavaScript
$jsonDataAnnee = json_encode($results_annee);

// Requête SQL pour les ventes par mois
$sql_ventes_mois = "
    SELECT 
...
// Préparer et exécuter la requête pour les ventes par mois
...
// Récupérer les résultats des ventes par mois
$results_mois = [];
...
// Convertir les résultats des ventes par mois en JSON pour JavaScript
