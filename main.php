...
<body>
    <nav role="navigation">
        <div id="menuToggle">
            ...
            <span></span>
            <ul id="menu">
                <a href="#" class="tablinks" onclick="openTab(event, 'All')"><li>All</li></a>
                <a href="#" class="tablinks" onclick="openTab(event, 'Cliente')"><li>Cliente</li></a>
                <a href="#" class="tablinks" onclick="openTab(event, 'Ruta')"><li>Ruta</li></a>
            </ul>
        </div>
    </nav>
