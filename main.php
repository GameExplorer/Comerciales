...
<html lang="es">
    ...
    <body>
        <div id="mySidenav" class="sidenav">
            <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times; <span id="pageTitle">Default Page
                    Title</span></a>
            <a href="?mes=<?php echo $MES; ?>&annee=<?php echo $ANNEE; ?>&query=ventas_por_cliente"
                onclick="updatePageTitle('Ventas por Cliente')">Ventas por Cliente</a>
            <a href="?mes=<?php echo $MES; ?>&annee=<?php echo $ANNEE; ?>&query=ventas_por_ruta"
                onclick="updatePageTitle('Ventas por comerciales')">Ventas por Comerciales</a>
            <a href="?mes=<?php echo $MES; ?>&annee=<?php echo $ANNEE; ?>&query=detalle_por_ruta"
                onclick="updatePageTitle('Detalle por Ruta')">Detalle por Ruta</a>
        </div>
