                        ...
                        <tbody>
                            ...
                            <?php foreach ($results_ruta as $row): ?>
                                <?php if (isset($row['COMERCIAL']) && !is_null($row['COMERCIAL'])): ?>
                                    <tr>
                                        <td><?php echo htmlentities($row['RUTA'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?php echo htmlentities($row['COMERCIAL'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                        <?php if ($queryType == 'detalle_por_ruta'): ?>
                                            <td><?php echo htmlentities($row['TIPO'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['COMISIONISTA'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['NOMBRE'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['FECHA'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['CodigoCliente'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['RazonSocial'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['NumeroFactura'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['BRUTO'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['DTO'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                            <td><?php echo htmlentities($row['FACTURADO'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                        <?php elseif ($queryType == 'ventas_por_ruta'): ?>
                                            <td><?php echo htmlentities($row['FACTURADO'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
                                        <?php else: ?>
                                            <td><?php echo htmlentities($row['CodigoCliente'] ?? '', ENT_QUOTES, 'UTF-8'); ?></td>
